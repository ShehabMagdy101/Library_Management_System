...
public class Book2 extends Book {
  static Book b2=new Book("جلسات نفسية"," محمد إبراهيم","عصير الكتب","2021",100,232,"9789776902190");
    
    
    
 
    private String info="تنمية ذاتية   ، علم نفس";
//--------------------------------------------
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("D:\\cloud\\OneDrive\\Pictures\\ovAojFZ41lCNJoJg0Uhy1E3w5XdVDHRAEulftKV8.png")); // NOI18N
        jButton1.setText("jButton1");
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 240, 350));
